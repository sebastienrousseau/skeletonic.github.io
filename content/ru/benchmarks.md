---
language: "ru"
title: "Бенчмарки размеров фреймворков — реальные данные, а не маркетинг"
...
layout: page
permalink: https://skeletonic.io/ru/benchmarks/
date: 2026-04-30
...
> **Подробная документация для этого раздела в настоящее время предоставляется на английском языке ниже. Мы работаем над полным переводом.** <!-- i18n-summary -->
